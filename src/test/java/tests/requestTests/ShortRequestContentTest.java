...
public class ShortRequestContentTest extends SuperTest {


    public ShortRequestContentTest() {
        super(web_a);
    }

    @Test
    public void shortRequestContentTest() {

        logIn("9000001000", "N12345678");

        ShortRequestCard shortRequestCard = requestPage.getShortRequestCard(0);

        assertMCS.equals(shortRequestCard.getContentSize(), 9, "количество полей не соответствует виду краткой карточки \n P.S. последующие ошибки могут не отражать действительности");
        ...
        assertMCS.equals(shortRequestCard.getRange(), null, " поле расстояния должно быть пустым");
