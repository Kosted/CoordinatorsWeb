...
public class FullRequestWithAddressContentTest extends SuperTest {


    public FullRequestWithAddressContentTest() {
        super(web_a);
    }
    ...
    public void fullRequestContentTest() {
        ...
        FullRequestCard fullRequestCard = requestPage.getFullRequestCard(3);
        ...
        assertMCS.notEquals(fullRequestCard.getRange(), "", "поле расстояния не должно быть пустым");
